# analise_saude/scripts/modelo_preditivo.py
...
from django.db.models import Count # Importe o Count aqui
import sys
...
def preparar_dados_para_treinamento():
    ...
    # Pega os dados climáticos dos últimos 2 anos
    ...
    # Vamos usar um threshold fixo para evitar erros com dados fictícios
    threshold = 5 
...
def treinar_modelo(df):
    ...
    # Treina o modelo (Random Forest Classifier é ótimo para isso)
...
def salvar_modelo(model):
    ...
    model_path = os.path.join(PROJECT_ROOT, 'analise_saude', 'modelo_preditivo.joblib')
...
if __name__ == "__main__":
    ...
    if len(df) > 50: # Garante que há dados suficientes para o treinamento
